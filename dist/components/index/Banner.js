...
var Banner = (_temp2 = _class = function (_BaseComponent) {
  ...
  function Banner() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Banner.__proto__ || Object.getPrototypeOf(Banner)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["more", "title"], _this.customComponents = [], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  more: _index4.default.bool
}, _class.defaultProps = {
  title: '哦豁',
  more: true
}, _class.$$componentPath = "components/index/Banner", _temp2);
